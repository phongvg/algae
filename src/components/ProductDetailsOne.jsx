              ...
              <div className='col-xl-6'>
                <div className='product-details__content'>
                  ...
                  <div className='flex-align flex-wrap gap-16 bg-color-one rounded-8 py-16 px-24'>
                    ...
                    <span className='text-gray-900 text-xs'>Remains untill the end of the offer</span>
                  </div>
                  <div className='mb-24'>
                    ...
                    <span className='text-sm text-gray-700 mt-8'>Available only:45</span>
                  </div>
                  ...
                  <div className='flex-between gap-16 p-12 border border-main-two-600 border-dashed rounded-8 mb-16'>
                    <div className='flex-align gap-12'>
                      <button type='button' className='w-18 h-18 flex-center border border-gray-900 text-xs rounded-circle hover-bg-gray-100'>
                        <i className='ph ph-plus' />
                      </button>
                      <span className='text-gray-900 fw-medium text-xs'>Mfr. coupon. $3.00 off 5</span>
                    </div>
                    <Link to='/cart' className='text-xs fw-semibold text-main-two-600 text-decoration-underline hover-text-main-two-700'>
                      View Details
                    </Link>
                  </div>
                  <ul className='list-inside ms-12'>
                    <li className='text-gray-900 text-sm mb-8'>Buy 1, Get 1 FREE</li>
          ...
          <div className='col-lg-3'>
            <div className='product-details__sidebar border border-gray-100 rounded-16 overflow-hidden'>
              ...
              <div className='p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100'>
                ...
                <div className=''>
                  <h6 className='text-sm mb-8'>Pickup available at Shop location</h6>
              ...
              <div className='p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100'>
                ...
                <div className=''>
                  ...
                  <p className='text-gray-700'>Payment upon receipt of goods, Payment by card in the department, Google Pay, Online card.</p>
                </div>
              </div>
              <div className='p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100'>
                <span className='w-44 h-44 bg-white text-main-600 rounded-circle flex-center text-2xl flex-shrink-0'>
                ...
                <div className=''>
                  ...
                  <p className='text-gray-700'>The Consumer Protection Act does not provide for the return of this product of proper quality.</p>
                </div>
              </div>
              <div className='p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100'>
                <span className='w-44 h-44 bg-white text-main-600 rounded-circle flex-center text-2xl flex-shrink-0'>
                ...
                <div className=''>
                  ...
                  <p className='text-gray-700'>Research &amp; development value proposition graphical user interface investor.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className='tab-content' id='pills-tabContent'>
                <div
                  ...
                  <div className='mb-40'>
                    ...
                    <p>
                      Wherever celebrations and good times happen, the LAY'S brand will be there just as it has been for more than 75 years. With
                      flavors almost as rich as our history, we have a chip or crisp flavor guaranteed to bring a smile on your face.{" "}
                    </p>
                    <p>
                      Morbi ut sapien vitae odio accumsan gravida. Morbi vitae erat auctor, eleifend nunc a, lobortis neque. Praesent aliquam
                      dignissim viverra. Maecenas lacus odio, feugiat eu nunc sit amet, maximus sagittis dolor. Vivamus nisi sapien, elementum sit
                      amet eros sit amet, ultricies cursus ipsum. Sed consequat luctus ligula. Curabitur laoreet rhoncus blandit. Aenean vel diam ut
                      arcu pharetra dignissim ut sed leo. Vivamus faucibus, ipsum in vestibulum vulputate, lorem orci convallis quam, sit amet
                      consequat nulla felis pharetra lacus. Duis semper erat mauris, sed egestas purus commodo vel.
                    </p>
                  ...
                  <div className='mb-40'>
                    ...
                    <ul className='mt-32'>
                      ...
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        ...
                        <span className='text-heading fw-medium'>
                          Product Name:
                          <span className='text-gray-500'> Potato Chips Classic </span>
                        </span>
                      </li>
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        <span className='w-20 h-20 bg-main-50 text-main-600 text-xs flex-center rounded-circle'>
                      ...
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        ...
                        <span className='text-heading fw-medium'>
                          Ingredients:
                          <span className='text-gray-500'> Potatoes, Vegetable Oil, and Salt.</span>
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className='mb-0'>
                    ...
                    <ul className='mt-32'>
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        ...
                        <span className='text-gray-500'> Lunarlon midsole delivers ultra-plush responsiveness</span>
                      </li>
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        <span className='w-20 h-20 bg-main-50 text-main-600 text-xs flex-center rounded-circle'>
                          <i className='ph ph-check' />
                        </span>
                        <span className='text-gray-500'> Encapsulated Air-Sole heel unit for lightweight cushioning</span>
                      </li>
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        <span className='w-20 h-20 bg-main-50 text-main-600 text-xs flex-center rounded-circle'>
                          <i className='ph ph-check' />
                        </span>
                        <span className='text-gray-500'> Colour Shown: Ale Brown/Black/Goldtone/Ale Brown</span>
                      </li>
                      <li className='text-gray-400 mb-14 flex-align gap-14'>
                        <span className='w-20 h-20 bg-main-50 text-main-600 text-xs flex-center rounded-circle'>
                          <i className='ph ph-check' />
                      ...
                      <div className='mt-56'>
                        ...
                        <div className='mt-32'>
                          <form action='#'>
                            ...
                            <button type='submit' className='btn btn-main rounded-pill mt-48'>
                              Submit Review
                            </button>
                          </form>
                        </div>
