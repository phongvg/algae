      ...
      <form action="#" className={`search-box ${activeSearch && "active"}`}>
        ...
        <div className="container">
          <div className="position-relative">
            <input
              type="text"
              className="px-24 py-16 text-xl form-control rounded-pill pe-64"
          ...
          <div className="flex-wrap gap-8 flex-between">
            ...
            <ul className="flex-wrap header-top__right flex-align">
              <li className="border-right-item">
                <Link
                  to="/account"
                  className="gap-6 py-8 text-sm text-white flex-align"
                >
      ...
      <header className="border-gray-100 header-middle bg-color-one border-bottom">
        <div className="container container-lg">
          <nav className="header-inner flex-between">
            ...
            <form
              action="#"
              className="flex-wrap flex-align form-location-wrapper"
            >
              <div className="h-48 search-category d-flex select-border-end-0 radius-end-0 search-form d-sm-flex d-none">
                <select
                  defaultValue={1}
                  className="border border-gray-200 js-example-basic-single border-end-0"
                  name="state"
                >
            ...
            <div className="header-right flex-align d-lg-block d-none">
              <div className="flex-wrap gap-12 flex-align">
                <button
                  type="button"
                  className="gap-4 search-icon flex-align d-lg-none d-flex item-hover"
                >
                ...
                <Link to="/cart" className="gap-4 flex-align item-hover">
                  <span className="mt-6 text-2xl text-gray-700 d-flex position-relative me-6 item-hover__text">
                    ...
                    <span className="w-16 h-16 text-xs text-white flex-center rounded-circle bg-main-600 position-absolute top-n6 end-n4">
                      0
                    </span>
                  </span>
                  <span className="text-gray-500 text-md item-hover__text d-none d-lg-flex">
                    Giỏ hàng
                  </span>
                </Link>
              </div>
        ...
        <div className="container container-lg">
          <nav className="gap-8 header-inner d-flex justify-content-between">
            ...
            <div className="header-right flex-align">
              <Link
                to="/tel:0982685849"
                className="gap-8 p-12 text-lg text-white bg-main-600 h-100 hover-bg-main-800 flex-align d-lg-flex d-none"
              >
